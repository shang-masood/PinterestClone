...
const Saved = (props) => {
  ...
  return (
    <div>
      <User />
      {openadd &&(
      <OpenAdd show={openadd} 
      close={() => {
        setOadd(false);}}/>
      )}
     
      <h1 className="BtnPlus"onClick={(e) => {setOadd(true);}}>
         +
      </h1>
...
`
const Pin_Bord=styled.div
  `
  width:250px;
  height:155px;
  
  `
  const Img_Board=styled.div
  `
  width:108px;
  height:155px;;
  z-index:0;
