...
const Settings=(props)=> {
    ...
    return (
        <div>
         ...
         <h6>photo </h6>
         <ImgP src={imgg} />
         <Btn onClick ={ (e) => {inputFile.current.click()}}> change</Btn> <br/>
         <Lbl>username</Lbl><br/>
         <In  value={name}/>
         </Sdiv>
         </Profile>
